...
namespace OopChess.Figures
{
    ...
    {
        public Queen(ChessBoard chessBoard, Location location, Color color) : base(chessBoard, location, color)
        {
        }

        public override string DisplayName => "D";
        ...
        public override void Move(Location toLocation)
        {
            ...
            else if (Math.Abs(CurrentLocation.X - toLocation.X) == Math.Abs(CurrentLocation.Y - toLocation.Y))
            {
